...
{
    public class MhwMemoryUpdaterX : MemoryUpdater
    {
        ...
        protected override void UpdateMemory()
        {
            ...
            if (false&&ConfigHelper.Main.Values.Overlay.MonsterWidget.IsVisible)
            {
            ...
            if (false&&ConfigHelper.Main.Values.Overlay.TeamWidget.IsVisible)
            {
